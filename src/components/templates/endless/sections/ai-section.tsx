...
export function AISection({ className }: { className?: string }) {
  return (
    <section className={`relative z-20 py-32 md:py-40 ${className ?? ""}`} style={{ backgroundColor: "#09090B" }}>
      <div
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          >
            <span className="text-white font-medium">Triggerly for Agents.</span> Choose from a variety of AI agents and start delegating work, from code generation to other technical tasks.
          </motion.p>
          ...
          <motion.button
            ...
            className="px-5 py-2.5 bg-zinc-800 text-zinc-300 rounded-lg border border-zinc-700 hover:bg-zinc-700 transition-colors text-sm flex items-center gap-2 mb-16 cursor-pointer"
          >
              ...
              >
                <div
                  style={{
                    ...
                    left: 0,
                    right: 0,
                    boxShadow: "inset 0 1.503px 5.261px rgba(255, 255, 255, 0.04), inset 0 -0.752px 0.752px rgba(255, 255, 255, 0.1)",
                    pointerEvents: "none",
                    zIndex: 10,
                  }}
                />
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="border-t border-r border-b border-zinc-800/60 pt-12 pr-6 md:pr-12 pb-16">
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5">
                  ...
                  <div className="bg-zinc-800/40 rounded-lg p-4 ml-0 md:ml-4">
                    ...
                    <button className="w-full flex items-center justify-center gap-2 bg-zinc-700/50 hover:bg-zinc-600/50 text-zinc-300 text-sm py-2.5 rounded-md transition-colors cursor-pointer">
              ...
              <div className="border-t border-b border-zinc-800/60 pt-12 pl-0 md:pl-12 pb-16">
                <h3 className="text-zinc-200 font-medium text-xl mb-3">Triggerly MCP</h3>
                <p className="text-zinc-500 text-base mb-8">
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5 font-mono text-sm">
                  <p className="text-zinc-700 mb-3">//mcp.triggerly.app/sse</p>
                  <div className="space-y-1 mb-6">
                    ...
                    <p className="pl-4">
                      <span className="text-orange-400/70">&quot;triggerly&quot;</span>
                      <span className="text-zinc-500">: {"{"}</span>
                    </p>
                    <p className="pl-8">
                  ...
                  <div className="bg-zinc-800/40 rounded-lg p-4">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <button className="flex items-center gap-1.5 border border-zinc-700/60 text-zinc-500 text-sm px-3 py-1.5 rounded-full hover:bg-zinc-700/30 transition-colors cursor-pointer">
