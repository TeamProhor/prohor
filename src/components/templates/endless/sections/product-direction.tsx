...
export function ProductDirectionSection({ className }: { className?: string }) {
  return (
    <section className={`relative py-32 md:py-40 px-6 md:px-12 lg:px-24 ${className ?? ""}`} style={{ backgroundColor: "#09090B" }}>
      <div
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Align your team around a unified product timeline.</span> Plan, manage, and track all product initiatives with Triggerly&apos;s visual planning tools.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-6 md:pr-10 pb-16">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-300 text-xs">
                    <span className="text-purple-400">🚩</span> Exploration
                  </span>
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-400 text-xs">
                    <span className="text-yellow-500">⚠</span> User interviews
                  </span>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-purple-500" /> Design Review{" "}
                    <span className="text-zinc-500">100%</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-purple-500" /> Internal Alpha{" "}
                    <span className="text-zinc-500">100% of 10</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-400 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 border border-zinc-500 bg-transparent" /> GA{" "}
                    <span className="text-zinc-500">25% of 53</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-b border-zinc-800 pt-10 pl-0 md:pl-10 pb-16">
            ...
            <div className="relative h-48">
              ...
              >
                <span className="flex items-center gap-2 text-zinc-500 text-sm">
                  <span className="w-1.5 h-1.5 rounded-full bg-zinc-500" /> Off track
                </span>
              </div>
              <div
              ...
              >
                <span className="flex items-center gap-2 text-zinc-400 text-sm">
                  <span className="w-1.5 h-1.5 rounded-full bg-zinc-400" /> At risk
                </span>
              </div>
              <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 border-b border-zinc-800">
          <div className="border-r border-zinc-800 pt-16 pr-6 md:pr-10 pb-16 flex flex-col justify-center">
