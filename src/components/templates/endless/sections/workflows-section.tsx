    ...
    <div className="flex items-center justify-center h-full">
      <div className="relative w-32 h-56 bg-zinc-900 rounded-2xl border border-zinc-700 overflow-hidden">
        ...
        <div className="mt-6 px-3">
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-6 bg-zinc-800/50 rounded mb-1" />
          ))}
        </div>
      </div>
    </div>
...
function FigmaMockup() {
  return (
    <div className="flex items-center justify-center h-full">
      <Sigma className="w-16 h-16 text-zinc-400" />
    </div>
  );
}
...
export function WorkflowsSection({ className }: { className?: string }) {
  ...
  return (
    <section className={`relative py-24 ${className ?? ""}`} style={{ backgroundColor: "#09090B" }}>
      <div
      ...
      <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="bg-zinc-900/50 border border-zinc-800/50 rounded-xl overflow-hidden h-[340px] flex flex-col">
                  ...
                  <div className="p-4 border-t border-zinc-800/30">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <button className="flex-shrink-0 w-8 h-8 rounded-full border border-zinc-700 flex items-center justify-center text-zinc-500 hover:text-zinc-300 hover:border-zinc-600 transition-colors cursor-pointer">
        ...
        <div className="flex items-center justify-center gap-2 mt-8">
          <button
            ...
            className="w-10 h-10 rounded-full border border-zinc-700 flex items-center justify-center text-zinc-400 hover:text-white hover:border-zinc-500 transition-colors disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer"
          >
