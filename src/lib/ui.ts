...
export const FEATURES_CONTENT = {
  ...
  badgeText: "দেশীয় ক্লাউড ও সর্বোচ্চ গতি",
  card1: {
    title: "ডিজাইন ও ইউআই",
    description:
...
export const MAD_FOR_DESIGNER_CONTENT = {
  ...
  codeSnippet: `/* Prohor Design System CSS Tokens */
--prohor-brand-primary: #00D084;
--prohor-local-gateway: "Prohor Pay";
  ...
  plans: [
    {
      ...
      features: [
        ...
        { label: "Prohor Pay পেমেন্ট চেকআউট", dim: true },
...
export const UPDATES_CONTENT = {
  ...
  paragraphs: [
    ...
    "সরাসরি Prohor Pay পেমেন্ট গেটওয়ে ওয়েবহুক প্রসেসিং এবং S3-কম্প্যাটিবল অবজেক্ট স্টোরেজের মাধ্যমে সারা দেশের গ্রাহকদের দিন চোখের পলকে ব্রাউজিং অভিজ্ঞতা।",
...
export const FOOTER_CONTENT = {
  ...
  privacyDisclaimer:
    "প্রহর আপনার গোপনীয়তা ও ডেটা সুরক্ষায় প্রতিশ্রুতিবদ্ধ। আমাদের ক্লাউড অবকাঠামো, S3-কম্প্যাটিবল স্টোরেজ ও Prohor Pay পেমেন্ট গেটওয়ে কঠোর এনক্রিপশন মানদণ্ড মেনে পরিচালিত হয়। আপনার ডেটা এনক্রিপ্ট করা থাকে এবং গ্রাহকের অনুমতি ছাড়া কোনো তথ্য তৃতীয় পক্ষের সাথে শেয়ার করা হয় না।",
};
